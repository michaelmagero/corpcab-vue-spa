                ...
                <div class="col-md-12">
                    <b-card class="mt-5 mb-5">
                        <b-container fluid>
                            ...
                            <!-- Main table element -->
                            <b-table class="mt-5" bordered striped show-empty small stacked="md" :items="vehicles" :fields="fields" :current-page="currentPage"
                            ...
                            :sort-direction="sortDirection" @filtered="onFiltered">
                                ...
                                <template v-slot:cell(status)="row">
									...
									<div v-else-if="row.item.status == 1">
										<b-badge variant="warning">In-Garage</b-badge>
									</div>

									<div v-else>
										<b-badge variant="danger">Our of Service</b-badge>
									</div>
                                </template>
